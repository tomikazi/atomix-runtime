...
type Primitive struct {
	ID PrimitiveID `protobuf:"bytes,1,opt,name=id,proto3,casttype=PrimitiveID" json:"id,omitempty"`
}
...
var fileDescriptor_d426e124a0fc8e61 = []byte{
	...
	,
}
...
func (c *runtimeClient) UpdatePrimitive(ctx context.Context, in *UpdatePrimitiveRequest, opts ...grpc.CallOption) (*UpdatePrimitiveResponse, error) {
	out := new(UpdatePrimitiveResponse)
	err := c.cc.Invoke(ctx, "/atomix.runtime.v1.Runtime/UpdatePrimitive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRuntimeServer) UpdatePrimitive(ctx context.Context, req *UpdatePrimitiveRequest) (*UpdatePrimitiveResponse, error) {
...
func _Runtime_UpdatePrimitive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePrimitiveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RuntimeServer).UpdatePrimitive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.runtime.v1.Runtime/UpdatePrimitive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuntimeServer).UpdatePrimitive(ctx, req.(*UpdatePrimitiveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Runtime_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Runtime_UpdatePrimitive_Handler,
		},
		{
...
func (m *Primitive) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ID = PrimitiveID(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
